...
{
	public delegate void SaveHtmlDlgt();
    ...
    public sealed partial class HtmlEditorControl : UserControl
    {
		...
		public event SaveHtmlDlgt SaveHtmlEditing;
		public event SaveHtmlDlgt CancelHtmlEditing;
		...
		{
			if (SaveHtmlEditing != null)
			{
				SaveHtmlEditing();
			}
		}

		private void cancelEditsToolStripMenuItem_Click(object sender, EventArgs e)
		{
			if (CancelHtmlEditing != null)
			{
				CancelHtmlEditing();
			}
		}
